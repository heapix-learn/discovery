...
public class VideoAdapter extends BaseAdapter {
    ...
    VideoAdapter(Context context, List<VideoItem> videItems) {
        this.context = context;
        this.videoItems = videItems;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Picasso.with(context).load(videoItems.get(position).getThumbnailURL()).resize(350, 250).centerCrop().into(thumbnail);
